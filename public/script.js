...
document.getElementById('filterReports').addEventListener('click', async () => {
    ...
    try {
        ...
        // Check if there are reports returned
        if (reports.length === 0) {
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            if (response.ok) {
                ...
                showManagementPage(); // Tampilkan halaman manajemen jika login berhasil
            } else {
        ...
        document.getElementById('logoutButton').addEventListener('click', () => {
            ...
            showLoginPage(); // Kembali ke halaman login
        });
        ...
        function showManagementPage() {
            document.getElementById('registerSection').style.display = 'none'; // Sembunyikan register
            document.getElementById('loginSection').style.display = 'none'; // Sembunyikan login
            document.getElementById('managementSection').style.display = 'block'; // Tampilkan manajemen
        }

        // Fungsi untuk menampilkan halaman login jika pengguna belum login
        function showLoginPage() {
            document.getElementById('registerSection').style.display = 'block'; // Tampilkan register
            document.getElementById('loginSection').style.display = 'block'; // Tampilkan login
            document.getElementById('managementSection').style.display = 'none'; // Sembunyikan manajemen
        }
